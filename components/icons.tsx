...
export const MarketsIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
...
export const PortfolioIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ fill: "currentcolor" }}
...
export const SpacesIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    id="Outline"
    style={{ fill: "currentcolor" }}
...
export const SidebarCloseIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    style={{ color: "currentcolor" }}
    viewBox="0 0 2236 1545"
    width={size}
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
  >
    <g transform="translate(-921 -380)">
      <g>
        <path
          d="M972.5 794.393C972.5 595.077 1134.08 433.5 1333.39 433.5L2742.61 433.5C2941.92 433.5 3103.5 595.077 3103.5 794.393L3103.5 1512.61C3103.5 1711.92 2941.92 1873.5 2742.61 1873.5L1333.39 1873.5C1134.08 1873.5 972.5 1711.92 972.5 1512.61Z"
          fill="none"
          fillRule="evenodd"
          stroke="currentColor"
          strokeWidth="100.833"
        />
        <path
          d="M1235.5 1473.09 1235.5 845.912C1235.5 745.721 1316.72 664.5 1416.91 664.5L1904.5 664.5 1904.5 1654.5 1416.91 1654.5C1316.72 1654.5 1235.5 1573.28 1235.5 1473.09Z"
          fill="currentColor"
          fillRule="evenodd"
          stroke="currentColor"
          strokeWidth="6.875"
...
export const SidebarOpenIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    overflow="hidden"
    style={{ color: "currentcolor" }}
  ...
  >
    <g transform="translate(-921 -380)">
      <g>
        ...
        />
        <path
          d="M91.5004 0 932.501 0C983.035-1.62962e-14 1024 40.9662 1024 91.5007L1024 91.5007C1024 142.035 983.034 183.001 932.5 183.001L91.5004 183C40.9661 183 0 142.034 0 91.4996L0 91.5007C-1.62961e-14 40.9662 40.9661-1.62962e-14 91.5004-1.62962e-14Z"
          fill="currentColor"
          fillRule="evenodd"
          stroke="currentColor"
          strokeWidth="6.875"
          transform="matrix(-1.83697e-16 -1 -1 1.83697e-16 1338.5 1675.5)"
        />
      </g>
    </g>
  </svg>
...
export const SciQntIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
      viewBox="180 0 600 600"
      width={size}
    >
      <g fill={"currentcolor"}>
        <path
          d="M291.645 133.69a20.385 20.385 0 1 1 40.765 0 20.385 20.385 0 0 1-40.765 0m-29.265 65.285a14.63 14.63 0 1 1 29.26 0 14.63 14.63 0 0 1-29.26 0m-36.015 102.3a21.635 21.635 0 1 1 43.265 0 21.635 21.635 0 0 1-43.265 0m29.015 75.915c0-11.33 9.125-20.51 20.385-20.51s20.385 9.18 20.385 20.51-9.125 20.51-20.385 20.51-20.385-9.18-20.385-20.51m395.445 23.76c0-7.735 6.215-14.005 13.88-14.005s13.88 6.27 13.88 14.005-6.215 14.005-13.88 14.005-13.88-6.27-13.88-14.005m31.015-96.425a21.635 21.635 0 1 1 43.265 0 21.635 21.635 0 0 1-43.265 0m-49.275-26.51c0-8.635 7.055-15.635 15.76-15.635s15.76 7 15.76 15.635-7.055 15.635-15.76 15.635-15.76-7-15.76-15.635m-22.51-48.65a15.76 15.76 0 1 1 31.515 0 15.76 15.76 0 0 1-31.515 0m58.28-65.41a20.385 20.385 0 1 1 40.765 0 20.385 20.385 0 0 1-40.765 0M550.275 76.54a23.51 23.51 0 1 1 47.025 0 23.51 23.51 0 0 1-47.025 0m-81.79-.625c0-10.705 8.735-19.385 19.51-19.385s19.51 8.68 19.51 19.385S498.77 95.3 487.995 95.3s-19.51-8.68-19.51-19.385m1.75 65.03a20.385 20.385 0 1 1 40.765 0 20.385 20.385 0 0 1-40.765 0m-98.55 26.14a13.005 13.005 0 1 1 26.01 0 13.005 13.005 0 0 1-26.01 0m0-106.43c0-7.115 5.825-12.88 13.005-12.88s13.005 5.765 13.005 12.88-5.825 12.88-13.005 12.88-13.005-5.765-13.005-12.88m34.27 29.515a11.63 11.63 0 1 1 23.26 0 11.63 11.63 0 0 1-23.26 0m179.59 89.795a11.63 11.63 0 1 1 23.26 0 11.63 11.63 0 0 1-23.26 0m39.52-49.4c0-6.49 5.21-11.755 11.63-11.755s11.63 5.265 11.63 11.755-5.21 11.755-11.63 11.755-11.63-5.265-11.63-11.755"
          fillRule="evenodd"
        />
        <path d="M476.24 154.075h13.505V322.91H476.24zM312.155 275.39h99.3v13.505h-99.3zm269.375 8.68-9.93-9.185 43.54-47.08 9.935 9.185Zm-290.955 96.54-9.475-9.655 45.77-44.915 9.475 9.655Zm238.15-176.81-10.12-8.985 46.25-52.07 10.115 8.985Z" />
        <path d="M564.78 79.04h13.51v66.285h-13.51z" />
        <path
          d="M316.7 217.065a6.27 6.27 0 0 1 8.86-.335l35.81 33.205a6.27 6.27 0 1 1-8.525 9.195l-35.81-33.205a6.27 6.27 0 0 1-.335-8.86"
          fillRule="evenodd"
        />
        <path
          d="M273.175 192.6a6.27 6.27 0 0 1 8.585-2.215l40.505 23.88a6.27 6.27 0 0 1-6.37 10.8l-40.505-23.88a6.265 6.265 0 0 1-2.215-8.585"
          fillRule="evenodd"
        />
        <path
          d="M308.155 222.985a12.13 12.13 0 1 1 24.26 0 12.13 12.13 0 0 1-24.26 0m2.07-78.515a6.27 6.27 0 0 1 8.8 1.085l38.25 48.995a6.27 6.27 0 0 1-9.885 7.715l-38.25-48.995a6.27 6.27 0 0 1 1.085-8.8m97.09 132.515a6.27 6.27 0 0 1 8.865.03l43.805 44.095a6.27 6.27 0 0 1-8.895 8.835l-43.805-44.095a6.27 6.27 0 0 1 .03-8.865m-154.085 21.4a6.27 6.27 0 0 1 4.665-7.54L318.4 276.61a6.27 6.27 0 0 1 2.875 12.2l-60.505 14.235a6.25 6.25 0 0 1-7.535-4.665"
          fillRule="evenodd"
        />
        <path
          d="M298.9 285.27c0-6.56 5.375-11.88 12.005-11.88s12.005 5.32 12.005 11.88-5.375 11.88-12.005 11.88-12.005-5.32-12.005-11.88m25.51 45.27a8.38 8.38 0 0 1 8.38-8.38h278.14a8.38 8.38 0 0 1 0 16.76H332.79a8.38 8.38 0 0 1-8.38-8.38"
          fillRule="evenodd"
        />
        <path
          d="M608.185 326.84a7.27 7.27 0 0 1 10.205 1.22l44.435 56.505a7.27 7.27 0 0 1-11.425 8.985l-44.435-56.505a7.27 7.27 0 0 1 1.22-10.205M477.49 304.4a16.25 16.25 0 0 1 16.26 16.26v228.865a16.26 16.26 0 0 1-32.52 0V320.66a16.25 16.25 0 0 1 16.26-16.26"
          fillRule="evenodd"
        />
        <path
          d="M385.99 209.01a6.13 6.13 0 0 0-.12 8.665l84.73 87.075a6.13 6.13 0 0 0 8.785-8.545l-84.73-87.08a6.13 6.13 0 0 0-8.665-.12"
          fillRule="evenodd"
        />
        <path
          d="M387.445 169.085a6.756 6.756 0 0 0-6.755 6.755v29.765a6.755 6.755 0 0 0 13.51 0V175.84a6.756 6.756 0 0 0-6.755-6.755"
          fillRule="evenodd"
        />
        <path
          d="M380.94 209.73a7.13 7.13 0 1 1 14.26 0 7.13 7.13 0 0 1-14.26 0m37.77-116.685a6.756 6.756 0 0 0-6.755 6.755v29.515a6.755 6.755 0 0 0 13.51 0V99.8a6.756 6.756 0 0 0-6.755-6.755m23.51 68.285a6.756 6.756 0 0 0-6.755 6.755v92.045a6.755 6.755 0 0 0 13.51 0v-92.045a6.756 6.756 0 0 0-6.755-6.755"
          fillRule="evenodd"
        />
        <path
          d="M415.18 126.575a6.765 6.765 0 0 0-1.515 9.445l23.31 32.215a6.765 6.765 0 0 0 10.96-7.93l-23.31-32.215a6.765 6.765 0 0 0-9.445-1.515m113.65 124.45a8.065 8.065 0 0 0-11.4.415l-36.34 39.07a8.065 8.065 0 1 0 11.815 10.985l36.34-39.07a8.065 8.065 0 0 0-.415-11.4"
          fillRule="evenodd"
        />
        <path
          d="M524.885 191.595a8.13 8.13 0 0 0-8.13 8.13V254a8.13 8.13 0 0 0 16.26 0v-54.275a8.13 8.13 0 0 0-8.13-8.13m37.145-46.9c0-5.18 4.255-9.38 9.505-9.38s9.505 4.2 9.505 9.38-4.255 9.38-9.505 9.38-9.505-4.2-9.505-9.38"
          fillRule="evenodd"
        />
        <path
          d="M593.045 218.61a8.006 8.006 0 0 0-8.005-8.005h-54.525a8.005 8.005 0 0 0 0 16.01h54.525a8.006 8.006 0 0 0 8.005-8.005"
          fillRule="evenodd"
        />
        <path
          d="M596.665 185.405a6.15 6.15 0 0 0-7.25 4.76l-6.04 29.15a6.14 6.14 0 0 0 12.01 2.49l6.04-29.15a6.15 6.15 0 0 0-4.76-7.25m72.77 6.29a6.135 6.135 0 0 0-8.675.04l-27.9 28.165a6.135 6.135 0 0 0 8.715 8.635l27.9-28.165a6.135 6.135 0 0 0-.04-8.675m-25.365 90.57a8.13 8.13 0 0 0-8.13-8.13h-88.795a8.13 8.13 0 0 0 0 16.26h88.795a8.13 8.13 0 0 0 8.13-8.13"
          fillRule="evenodd"
        />
        <path
          d="M549.065 281.77a8.885 8.885 0 0 0-12.565.33l-35.685 37.605a8.88 8.88 0 1 0 12.89 12.23l35.685-37.605a8.885 8.885 0 0 0-.33-12.565Z"
          fillRule="evenodd"
        />
        <path
          d="M536.52 285.27c0-5.18 4.145-9.38 9.255-9.38s9.255 4.2 9.255 9.38-4.145 9.38-9.255 9.38-9.255-4.2-9.255-9.38m-89.44-52.74c1.68 11.39-4.74 21.765-14.33 23.18-6.04.89-12.195-2.01-16.255-7.655l6.41-6.285c3.08 5.47 8.63 6.915 12.39 3.225 2.52-2.475 3.69-6.775 3.045-11.18Zm63.015 45.955c-7.545 6.93-18.975 6.755-25.535-.39-3.9-4.25-5.35-10.26-3.87-16.065l8.68 1.745c-1.525 4.98 1.21 9.81 6.095 10.795 2.985.6 6.24-.375 8.655-2.59Zm101.66 6.365c-9.845 2.82-19.995-2.445-22.665-11.77-1.59-5.55-.2-11.57 3.725-16.1l6.985 5.44c-3.59 3.77-3.305 9.315.625 12.38 2.405 1.875 5.75 2.455 8.9 1.555Zm-72.405 48.47c-10.97 2.335-21.495-3.46-23.515-12.945-1.255-5.9 1.08-12.13 6.185-16.505l6.655 5.975c-4.935 3.435-5.79 9.045-1.91 12.525 2.555 2.295 6.67 3.175 10.75 2.31Z"
          fillRule="evenodd"
        />
        <path
          d="M518.52 319.97c-8.835 7.945-22.9 6.715-31.41-2.75-4.745-5.28-6.955-12.305-5.99-19.045l10.625 2.25c-.485 6.245 4.205 12.385 10.48 13.71 3.375.715 6.69-.1 9.05-2.22Zm-90.055 5.145c14.81 5.2 34.605 23.925 45.885 43.415l-12.515-2.88c-8.145-10.885-18.43-21.565-26.92-27.955Zm55.93 44.89c2.95-14.015 17.08-31.325 31.56-38.66 2.945-1.49 5.765-2.49 8.345-2.96l-4.47 9.255c-9.17 4.99-20.595 17.125-25.925 27.545Z"
          fillRule="evenodd"
        />
        <path
          d="M506.505 332.415c0-10.5-8.51-19.01-19.01-19.01h-23.26a19.01 19.01 0 1 0 0 38.02h23.26c10.5 0 19.01-8.51 19.01-19.01"
          fillRule="evenodd"
        />
        <path
          d="M473.875 292.285c4.565 8.11.33 19.725-9.46 25.945-6.695 4.25-14.58 5.02-20.38 1.975l4.77-6.56c4.985 1.775 12.315-1.305 16.375-6.885 2.565-3.53 3.3-7.39 1.935-10.18Z"
          fillRule="evenodd"
        />
        <path
          d="M490.245 289.895a4.5 4.5 0 0 0-4.5-4.5h-15.51a4.5 4.5 0 0 0 0 9h15.51a4.5 4.5 0 0 0 4.5-4.5m-57.28 28.64c0-6.56 5.375-11.88 12.005-11.88s12.005 5.32 12.005 11.88-5.375 11.88-12.005 11.88-12.005-5.32-12.005-11.88"
          fillRule="evenodd"
        />
      </g>
    </svg>
...
export const MarketsIconFill = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ fill: "currentcolor" }}
...
export const MessageIconFill = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ fill: "currentcolor" }}
...
export const PortfolioIconFill = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    style={{ fill: "currentcolor" }}
...
export const SpacesIconFill = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    id="Outline"
    style={{ fill: "currentcolor" }}
